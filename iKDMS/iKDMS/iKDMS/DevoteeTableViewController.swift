...
//        cell.lblName.text = (devotee.firstName ?? "" + " ")// + devotee.lastName ?? "" ?? "") ?? ""
    ...
    @objc private func LoadDevoteeRecords()  {
        ...
        switch selectedTabIndex {
        case 0:
            urlString = "http://192.168.0.101/KDMS/api/searchDevotee.php?mode=iSET&key=CTP"
        case 1:
            urlString = "http://192.168.0.101/KDMS/api/searchDevotee.php?mode=iSET&key=DWP"
        case 2:
            urlString = "http://192.168.0.101/KDMS/api/searchDevotee.php?mode=iSET&key=PWD"
        default:
            urlString = "http://192.168.0.101/KDMS/api/searchDevotee.php?mode=iSET&key=CTP"
        }
  ...
  //          print(imageData)
    ...
    /* @objc func Refresh(sender:AnyObject) {
     ...
     let urlString = "http://192.168.0.101/KDMS/api/searchDevotee.php?mode=KEY&key=" + devotee.devoteeKey!
     //print(urlString)
