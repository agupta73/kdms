    <form id="formAmenity">
        <div class="modal fade" id="ParticipationModalLong" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog kdms-modal-addDevotee" role="document">
                <div class="modal-content">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title kdms-adddevotee-card-title">Accommodation, Seva, Amenity & Remarks Records</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="card-header">
                                                    <h4 class="card-title kdms-adddevotee-card-title">Accommodation</h4>
                                                </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="card-header">
                                                    <h4 class="card-title kdms-adddevotee-card-title">Seva</h4>
                                                </div>
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        <thead class="text-primary">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="card-header">
                                                    <h4 class="card-title kdms-adddevotee-card-title">Amenity</h4>
                                                </div>
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        <thead class="text-primary">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="card-header">
                                                    <h4 class="card-title kdms-adddevotee-card-title">Remarks</h4>
                                                </div>
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        <thead class="text-primary">
