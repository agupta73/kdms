...
DROP PROCEDURE IF EXISTS `PROC_INITIALIZE_EVENT`;
...
/*--------------------------------------`PROC_INSERT_DEVOTEE`----------------------------------------------------*/
DROP PROCEDURE IF EXISTS `PROC_INSERT_DEVOTEE` ;     

DELIMITER ;;
CREATE  PROCEDURE `PROC_INSERT_DEVOTEE`(IN `p_Devotee_Key` VARCHAR
...
/*-------------------------------------`PROC_INSERT_DEVOTEE_W_SEVA` ----------------------------------------------------*/
DROP PROCEDURE IF EXISTS `PROC_INSERT_DEVOTEE_W_SEVA` ;

DELIMITER ;;
CREATE  PROCEDURE `PROC_INSERT_DEVOTEE_W_SEVA`(IN `p_Devotee_Key` VARCHAR(10), IN `p_Devotee_Type` VARCHAR(30), IN `p_Devotee_First_Name` VARCHAR(50), IN `p_Devotee_Last_Name` VARCHAR(50), IN `p_Devotee_Gender` VARCHAR(6), IN `p_Devotee_ID_Type` VARCHAR(10), IN `p_Devotee_ID_Number` VARCHAR(50), IN `p_Devotee_Station` VARCHAR(50), IN `p_Devotee_Cell_Phone_Number` VARCHAR(15), IN `p_Devotee_Status` VARCHAR(20), IN `p_Devotee_Remarks` VARCHAR(250), IN `p_Devotee_Referral` VARCHAR(100), IN `p_Devotee_Seva_Id` VARCHAR(6), IN `p_Devotee_Seva_Status` VARCHAR(10), IN `p_Devotee_Record_Updated_By` VARCHAR(10), IN `p_Devotee_Accommodation_ID` VARCHAR(10), IN `p_Devotee_Accomodation_Status` VARCHAR(10))
BEGIN
...
DROP PROCEDURE IF EXISTS `PROC_INSERT_DEVOTEE_W_SEVA_I` ;

DELIMITER ;;
CREATE  PROCEDURE `PROC_INSERT_DEVOTEE_W_SEVA_I`(
...
/*-------------------------------------`PROC_MANAGE_AMENITY`----------------------------------------------------*/
DROP PROCEDURE IF EXISTS `PROC_MANAGE_AMENITY` ;

DELIMITER ;;
CREATE  PROCEDURE `PROC_MANAGE_AMENITY`(
    IN `p_Devotee_Key` VARCHAR(10),
...
DROP PROCEDURE IF EXISTS `PROC_REFRESH_ACCO_COUNT` ;

DELIMITER ;;
CREATE  PROCEDURE `PROC_REFRESH_ACCO_COUNT`()
BEGIN
...
/*-------------------------------------`PROC_REFRESH_AMENITIES_COUNT`  ----------------------------------------------------*/
DROP PROCEDURE IF EXISTS `PROC_REFRESH_AMENITIES_COUNT` ;

DELIMITER ;;
CREATE  PROCEDURE `PROC_REFRESH_AMENITIES_COUNT`(
	IN `p_Event_Id` VARCHAR(10)
)
BEGIN
...
DROP PROCEDURE IF EXISTS `PROC_REFRESH_AMENITY_COUNT` ;

DELIMITER ;;
CREATE  PROCEDURE `PROC_REFRESH_AMENITY_COUNT`()
BEGIN
...
/*---------------------------------------`PROC_REFRESH_SEVA_COUNT`----------------------------------------------------*/
DROP PROCEDURE IF EXISTS `PROC_REFRESH_SEVA_COUNT`;

DELIMITER ;;
CREATE  PROCEDURE `PROC_REFRESH_SEVA_COUNT`()
BEGIN
...
DROP PROCEDURE IF EXISTS `PROC_REPLACE_DEVOTEE` ;

DELIMITER ;;
CREATE  PROCEDURE `PROC_REPLACE_DEVOTEE`(IN `p_Devotee_Key` VARCHAR
(10), IN `p_Devotee_Type` VARCHAR
(30), IN `p_Devotee_First_Name` VARCHAR
(50), IN `p_Devotee_Last_Name` VARCHAR
(50), IN `p_Devotee_Gender` VARCHAR
...
/*----------------------------------------`PROC_REPLACE_DEVOTEE_W_SEVA` ----------------------------------------------------*/
DROP PROCEDURE IF EXISTS  `PROC_REPLACE_DEVOTEE_W_SEVA`;

DELIMITER ;;
CREATE  PROCEDURE `PROC_REPLACE_DEVOTEE_W_SEVA`(IN `p_Devotee_Key` VARCHAR(10), IN `p_Devotee_Type` VARCHAR(30), IN `p_Devotee_First_Name` VARCHAR(50), IN `p_Devotee_Last_Name` VARCHAR(50), IN `p_Devotee_Gender` VARCHAR(6), IN `p_Devotee_ID_Type` VARCHAR(10), IN `p_Devotee_ID_Number` VARCHAR(50), IN `p_Devotee_Station` VARCHAR(50), IN `p_Devotee_Cell_Phone_Number` VARCHAR(15), IN `p_Devotee_Status` VARCHAR(20), IN `p_Devotee_Remarks` VARCHAR(250), IN `p_Devotee_Referral` VARCHAR(100), IN `p_Devotee_Seva_Id` VARCHAR(6), IN `p_Devotee_Seva_Status` VARCHAR(10), IN `p_Devotee_Record_Updated_By` VARCHAR(10), IN `p_Devotee_Accommodation_ID` VARCHAR(10), IN `p_Devotee_Accomodation_Status` VARCHAR(10))
BEGIN
...
/*------------------------------------- `PROC_UPDATE_DEVOTEE` ----------------------------------------------------*/
DROP PROCEDURE IF EXISTS `PROC_UPDATE_DEVOTEE` ;

DELIMITER ;;
CREATE  PROCEDURE `PROC_UPDATE_DEVOTEE`(IN `p_Devotee_Key` VARCHAR
(10), IN `p_Devotee_Type` VARCHAR
(30), IN `p_Devotee_First_Name` VARCHAR
(50), IN `p_Devotee_Last_Name` VARCHAR
(50), IN `p_Devotee_Gender` VARCHAR
...
/*-----------------------------------------`PROC_UPSERT_ACCO` ----------------------------------------------------*/
DROP PROCEDURE IF EXISTS  `PROC_UPSERT_ACCO`;

DELIMITER ;;
CREATE  PROCEDURE `PROC_UPSERT_ACCO`(IN `p_Accomodation_Key` VARCHAR
...
/*----------------------------------------`PROC_UPSERT_SEVA_W_AVAIL_UPDATE` ----------------------------------------------------*/
DROP PROCEDURE IF EXISTS `PROC_UPSERT_SEVA_W_AVAIL_UPDATE` ;
...
/*----------------------------------------`PROC_REGISTER_EXISTING_DEVOTEE_FOR_EVENT` ----------------------------------------------------*/
DROP PROCEDURE IF EXISTS `PROC_REGISTER_EXISTING_DEVOTEE_FOR_EVENT`;

DELIMITER $$
CREATE DEFINER=`kdms`@`%` PROCEDURE `PROC_REGISTER_EXISTING_DEVOTEE_FOR_EVENT`(
	IN `p_Devotee_Key` VARCHAR(10),
	IN `p_Devotee_Seva_Id` VARCHAR(6),
	IN `p_Devotee_Seva_Status` VARCHAR(10),
	IN `p_Devotee_Accommodation_ID` VARCHAR(10),
...
-- Upsert Devotee Record - not needed for existing devotees
       /*
       REPLACE INTO devotee(
        Devotee_Key,
        Devotee_Type,
...
-- Log Entry
IF DEBUG = true THEN
		CALL logIt(concat('PROC_REGISTER_EXISTING_DEVOTEE_FOR_EVENT: Devotee record replaced. Devotee ID: ', p_Devotee_Key));
END IF;
*/
/* =========== Removing use of demographics table for now.. adding fields directly into devotee table =========================
-- Demographics table Update - simply replace the record
...
-- Log entry
IF DEBUG = true THEN
		CALL logIt(concat('PROC_REGISTER_EXISTING_DEVOTEE_FOR_EVENT: No Past Accommodation Record Found for the current event. Devotee ID: ', p_Devotee_Key, ' accommocation ID: ' , p_Devotee_Accommodation_ID, ' event ID: ', p_Event_ID));
END IF;
...
-- Long entry
IF DEBUG = true THEN
		CALL logIt(concat('PROC_REGISTER_EXISTING_DEVOTEE_FOR_EVENT: Accommodation Count reduced. Devotee ID: ', p_Devotee_Key, ' accommocation ID: ' , p_Devotee_Accommodation_ID, ' event ID: ', p_Event_ID));
END IF;
END IF;
...
-- Log entry
IF DEBUG = true THEN
		CALL logIt(concat('PROC_REGISTER_EXISTING_DEVOTEE_FOR_EVENT: Accommodation availability record added and allocation increased. Devotee ID: ', p_Devotee_Key, ' accommocation ID: ' , p_Devotee_Accommodation_ID, ' event ID: ', p_Event_ID));
END IF;
END IF;
...
IF DEBUG = true THEN
		CALL logIt(concat('PROC_REGISTER_EXISTING_DEVOTEE_FOR_EVENT: No past seva found for the current event/seva. Devotee ID: ', p_Devotee_Key, ' Seva ID: ' , p_Devotee_Seva_Id, ' event ID: ', p_Event_ID));
END IF;
