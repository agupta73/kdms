...
<div class="modal fade" id="RemarksModalLong2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
    aria-hidden="true">
...
<script>
    ...
    function validateRemark(formId) {
        if ($('#devotee_key').value == "") {
                    alert("Devotee Key not specified. Please select another record or refresh the report.");
                    return false;
                } else {
                    return true;
                }
