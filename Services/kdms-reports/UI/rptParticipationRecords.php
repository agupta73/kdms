                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    if(!empty($_GET['devoteeKey'])){
                                        $devoteeKey = $_GET['devoteeKey'];
                                    }
                                    else {
                                        die;
                                    }
                                    $devoteeParicipationSearch = new clsServicesManager($devoteeKey);
                                    $devoteeParicipationSearch->setOptionType("DPR");
                                    $PRResponse = $devoteeParicipationSearch->getRecords();
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            foreach ($PRResponse[0] as $PRValue) {
                                                ...
                                                print_r("</td><td style='width: 150px;font-size: small' >");
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            foreach ($PRResponse[1] as $PRValue) {
                                                //var_dump($PRValue);
                                                print_r("<td style='width: 100px;font-size: small'>");
                                                print_r(urldecode($PRValue['Event']));

                                                print_r("</td><td style='width: 100px;font-size: small' >");
                                                print_r(urldecode($PRValue['Seva']));

                                                print_r("</td><td style='width: 200px;font-size: small'>");
                                                print_r(urldecode($PRValue['Attendance']));
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            foreach ($PRResponse[3] as $PRValue) {
                                                ...
                                                print_r("</td><td style='width: 280px;font-size: small' >");
